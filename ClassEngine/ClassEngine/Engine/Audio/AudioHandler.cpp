...
bool AudioHandler::Initialize(glm::vec3 pos_ = glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3 vel_ = glm::vec3(0.0f, 0.0f, 0.0f),
	glm::vec3 forward_ = glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3 up_ = glm::vec3(0.0f, 1.0f, 0.0f)) {
