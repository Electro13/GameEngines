...
Emitter::Emitter(int particles_, std::string shaderProgram_) {
	//ShaderHandler::GetInstance()->CreateProgram(particleVertexShaderName, particleShaderProgramName, particleFragmentShaderName);
	//TextureHandler::GetInstance()->CreateTexture("ass", "fuck");
